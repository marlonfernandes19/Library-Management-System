...
<div class="card-panel grey lighten-5">
            <div>
                <input type="text" name="username" class="form-control" placeholder=" Worker ID" required=""/>
            </div>
            <div>
            ...
            <div>
              ...
              <div><center>
              <button class="btn waves-effect waves-light " type="submit" name="submit1">Log in
...
<?php
  ...
  if(isset($_POST["submit1"]))
  {
    ...
    $sql_query = "select * from librarian_details where Worker_ID = '$username1' && Password = '$password'; ";
    ...
    { $res=mysqli_query($link,"select * from librarian_details where Worker_ID = '$username1';");
